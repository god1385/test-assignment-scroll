...
namespace AxGrid.Tools.Binders
{
    ...
    public class UIButtonDataBind : Binder
    {
        ...
        public void Init()
        {
            ...
            {
                UnityEngine.Debug.LogError($"[UIButtonDataBind] Init: {e.Message}", this);
            }
        }
        ...
        protected void EveryFrame()
        {
            try
            {
                if (button == null || !button.interactable || key == "")
                    return;
            ...
            {
                UnityEngine.Debug.LogError($"[UIButtonDataBind] EveryFrame: {e.Message}", this);
            }
        }
    }
}